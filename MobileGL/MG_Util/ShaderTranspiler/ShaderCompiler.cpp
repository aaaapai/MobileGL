    ...
    namespace MG_Util {
        namespace ShaderTranspiler {
            ...
            Result<SharedPtr<glslang::TShader>> ShaderCompiler::CompileShader(const ShaderAttrib& attrib) {
                ...
                shaderc_compile_options_set_forced_version_profile(shaderc_opts, 460, shaderc_profile_core);
                ...
                //shaderc_compile_options_add_macro_definition(shaderc_opts, "noperspective", strlen("noperspective"), "", 0);
                ...
                if (!tshader->parse(&GetTBuiltInResourceInstance(), 460, ECoreProfile/*ECompatibilityProfile*/,
