...
namespace GLES {
    namespace Caps {
        ...
        namespace Exts {
            static int GL_EXT_buffer_storage;
            static int GL_EXT_disjoint_timer_query;
            static int GL_QCOM_texture_lod_bias;
            [[maybe_unused]] static int GL_EXT_blend_func_extended;
            [[maybe_unused]] static int GL_EXT_texture_format_BGRA8888;
            [[maybe_unused]] static int GL_EXT_read_format_bgra;
            static int GL_OES_mapbuffer;
            static int GL_EXT_multi_draw_indirect;
            static int GL_OES_draw_elements_base_vertex;
            static int GL_OES_depth_texture;
            static int GL_OES_depth24;
            static int GL_OES_depth_texture_float;
            static int GL_EXT_texture_norm16;
            static int GL_EXT_texture_rg;
        }
    }
...
#define LOAD_EGL(name)                                                                                                                              \
        ...
        {                                                                                                                                                   \
            ...
            if (first) {                                                                                                                                    \
                first = false;                                                                                                                              \
                if (MG_GL::BackendLoader::GLESBackend::libEGL != NULL) {                                                                                    \
                    egl_##name = (EGL::name##_PTR)MG_GL::BackendLoader::GLESBackend::ProcAddress(MG_GL::BackendLoader::GLESBackend::libEGL, #name);         \
                }                                                                                                                                           \
            }                                                                                                                                               \
        }
...
namespace MG_GL::BackendLoader {
    ...
    namespace GLESBackend {
        ...
        #define INIT_GLES_FUNC(name)                                                                                                                        \
            {                                                                                                                                               \
                GLES::name = (name##_PTR)ProcAddress(libGLES, #name);                                                                                       \
            }
    }
}
